<template>
    <section class="h-96 bg-cover bg-gray-900"
             v-bind:style="{ 'background-image': 'url(' + this.heroImage + ')', 'height':'600px'}"
    >
        <div class="flex h-full w-full items-center justify-center container mx-auto px-8">
            <div class="max-w-2xl text-center">
                ...
                <p class="mt-6 lg:text-lg text-white">You can subscribe to our newsletter, and let you know when we are
                    back</p>
